    ...
    def _setup_keybinder(self):
        ...
        try:
            ...
            try:
                ...
                print(
                    "Aviso: python-xlib não está instalado. Atalho global Super+J não estará disponível.",
                    file=sys.stderr,
                )
            ...
            try:
                ...
                print(
                    f"Aviso: Não foi possível conectar ao servidor X11: {e}",
                    file=sys.stderr,
                )
                print(
                    "  Atalho global requer X11 (não funciona em Wayland puro)",
                    file=sys.stderr,
                )
                self._xlib_available = False
                return
            ...
            try:
                ...
                try:
                    ...
                    if not self._stop_event.is_set():
                        print(
                            f"Erro ao processar eventos de teclado: {e}",
                            file=sys.stderr,
                        )
