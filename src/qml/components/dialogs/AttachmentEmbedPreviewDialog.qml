...
Controls.Dialog {
    ...
    onOpened: {
        ...
        if (filePath) {
            var info = (clipboardHelper && typeof clipboardHelper.getFileInfo === "function") ? clipboardHelper.getFileInfo(filePath) : {};
    ...
    ColumnLayout {
        ...
        Item {
            ...
            Image {
                ...
                height: width > 0 && sourceSize.width > 0 ? Math.min(parent.height - Kirigami.Units.smallSpacing * 2, (sourceSize.height / sourceSize.width) * width) : 0
        ...
        Kirigami.FormLayout {
            ...
            Controls.Label {
                ...
                text: (fileInfoModel.width && fileInfoModel.height) ? (fileInfoModel.width + "×" + fileInfoModel.height) : "—"
            }
            Controls.Label {
        ...
        RowLayout {
            ...
            Repeater {
                model: [
                    ...
                    {
                        value: "wrap-left",
                        label: qsTr("Wrap Left")
                    },
                    {
                        value: "wrap-right",
                        label: qsTr("Wrap Right")
                    },
                    {
                        value: "wide",
                        label: qsTr("Wide")
                ...
                Controls.RadioButton {
                    ...
                    onCheckedChanged: if (checked)
                        dialog.selectedLayout = modelData.value
                }
            }
        }
        ...
        RowLayout {
            ...
            Controls.Button {
                text: dialog.embedTarget === "comment" ? qsTr("Embedar no comentário") : qsTr("Embedar na Description")
                onClicked: {
