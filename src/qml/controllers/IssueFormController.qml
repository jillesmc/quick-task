...
Item {
    ...
    function createIssue() {
        ...
        // Chamar serviço
        jiraService.createIssue(data.summary, data.description, data.tipoAtividade, data.statusInicial, data.documentacaoAnexa, data.utilizacaoIA, data.valorEntregue, data.plataformasAfetadas, data.registrarWorklog, data.worklogInicio, data.worklogDuracao, "" // timezone vazio - será usado o do config.json automaticamente
        , data.parentEpicKey, data.worklogComment, data.pendingAttachments || [], data.prioridade || "Medium");
    }
