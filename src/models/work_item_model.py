"""
Modelo de dados para um work item no formulário de criação/edição.
...
class WorkItemModel(QObject):
    ...
    def __init__(self, parent=None):
        ...
        try:
            ...
            debug_log("WorkItemModel", "__init__", "Carregando configuração...")
            self._config = ConfigManager()
            debug_log("WorkItemModel", "__init__", "Configuração carregada com sucesso")
    ...
    def set_assets_cache(self, cache: Any) -> None:
        """Define o serviço de cache de Assets (chamado pelo app após criar o serviço de integração). Nunca levanta."""
        try:
