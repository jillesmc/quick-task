...
class WorklogDatabase:
    ...
    def _init_database(self) -> None:
        ...
        debug_log(
            "WorklogDatabase",
            "_init_database",
            "Inicializando banco de dados em: %s",
            self.db_path,
        )
    ...
    def save_session(
        ...
        debug_log(
            "WorklogDatabase",
            "save_session",
            "Salvando sessão: %s para issue %s",
            session_id,
            issue_key,
        )
    ...
    def get_pending_worklogs(self) -> List[Dict[str, Any]]:
        ...
        """
        debug_log(
            "WorklogDatabase", "get_pending_worklogs", "Buscando worklogs pendentes"
        )
        ...
        debug_log(
            ...
            "Encontrados %d worklogs pendentes",
            len(sessions),
        )
        return sessions
    ...
    def mark_as_synced(self, session_id: str, jira_worklog_id: str) -> None:
        ...
        debug_log(
            "WorklogDatabase",
            "mark_as_synced",
            "Marcando sessão %s como sincronizada",
            session_id,
        )
        ...
        debug_log(
            "WorklogDatabase", "mark_as_synced", "Sessão marcada como sincronizada"
        )
    ...
    def update_session(
        ...
        """
        debug_log(
            "WorklogDatabase", "update_session", "Atualizando sessão: %s", session_id
        )
    ...
    def delete_session(self, session_id: str) -> None:
        ...
        """
        debug_log(
            "WorklogDatabase", "delete_session", "Deletando sessão: %s", session_id
        )
    ...
    def delete_all_worklogs(self) -> int:
        ...
        debug_log(
            "WorklogDatabase",
            "delete_all_worklogs",
            "Deletando todos os worklogs pendentes",
        )
